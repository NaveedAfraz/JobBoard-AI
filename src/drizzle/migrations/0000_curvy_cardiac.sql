CREATE TYPE "public"."job_listings_experience_level" AS ENUM('entry-level', 'mid-level', 'senior-level');--> statement-breakpoint
...
CREATE TYPE "public"."job_listings_location_requirement" AS ENUM('on-site', 'remote', 'hybrid');--> statement-breakpoint
